# Upstream snapshot: steipete/agent-scripts skills/codex-first

Source: https://github.com/steipete/agent-scripts/blob/main/skills/codex-first/SKILL.md
Fetched: 2026-08-19
Do not invoke. Live doctrine is ../SKILL.md (`cli-agent-first`).
