---
name: concise
description: "Concise response style — lead with the result, cut narration. Load when the user asks for brevity: /concise, «короче», «кратко», «без воды», or for a whole session in short mode."
---
