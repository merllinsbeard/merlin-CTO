---
name: tailwind-v4
description: Use when writing or reviewing Tailwind CSS v4 classes or migrating v3 syntax.
---
...
Applies to any repo with Tailwind, not only the Mastra playground. Read the project's pinned `tailwindcss` version. Do not assume 4.3.3. If the project is still on v3, do not force a v4 rewrite unless the user asked.
