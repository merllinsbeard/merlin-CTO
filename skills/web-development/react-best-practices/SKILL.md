...
description: Mastra React subset only. Generic React or Next uses vercel-react-best-practices.
---
...
This is the Mastra 26-rule subset. For ordinary React or Next, load `vercel-react-best-practices` instead.

Use this file only when the user named Mastra or the repo is a Mastra app.
